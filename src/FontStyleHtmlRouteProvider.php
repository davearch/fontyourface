...
/**
 * @file
 * Contains \Drupal\fontyourface\FontStyleHtmlRouteProvider.
 */
...
/**
 * Provides routes for Font style entities.
 *
 * @see Drupal\Core\Entity\Routing\AdminHtmlRouteProvider
 * @see Drupal\Core\Entity\Routing\DefaultHtmlRouteProvider
 */
class FontStyleHtmlRouteProvider extends AdminHtmlRouteProvider {
  /**
   * {@inheritdoc}
   */
