...
- Go to Administration È Modules and enable @font-your-face and one or more of the submodules.
- Go to Administration È Appearance È @font-your-face È settings and import the fonts.

2a. Use @font-your-face via the interface:
==========================================
- Go to Administration È Appearance È @font-your-face (admin/appearance/font) 
  to enable some fonts. 
- Click the 'enable font' for each font you want to use.
- You can add CSS selectors for each enabled font via  Administration È Appearance È @font-your-face È Font Display (admin/appearance/font/font_display)
